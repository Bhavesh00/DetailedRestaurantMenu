...
public class Item {
    ...
    public static Item[] ITEMS = new Item[] {
            ...
            new Item(R.string.coktails, R.string.fresh_lime_margarita, R.drawable.fresh_lime_margarita, R.string.fresh_lime_margarita_desc, R.string.six_fifty_dollar, new int[] {R.drawable.dairy_free}),
            new Item(R.string.coktails, R.string.paloma, R.drawable.paloma, R.string.paloma_desc, R.string.six_fifty_dollar, new int[] {R.drawable.dairy_free}),
            new Item(R.string.coktails, R.string.russo_mexicano, R.drawable.russo_mexicano, R.string.russo_mexicano_desc, R.string.seven_dollar),
            new Item(R.string.coktails, R.string.seasonal_margarita_avacado, R.drawable.seasonal_margarita___avacado, R.string.seasonal_margarita_avacado_desc, R.string.eleven_dollar, new int[] {R.drawable.dairy_free, R.drawable.vegan}),
            new Item(R.string.coktails, R.string.seasonal_margarita_blackberry_mint, R.drawable.seasonal_margarita___blackberry_mint, R.string.seasonal_margarita_blackberry_mint_desc, R.string.eight_fifty_dollar, new int[] {R.drawable.dairy_free, R.drawable.vegan}),
            new Item(R.string.coktails, R.string.mango_habanero, R.drawable.mango_habanero, R.string.mango_habanero_desc, R.string.seven_fifty_dollar, new int[] {R.drawable.dairy_free, R.drawable.vegan}),
            new Item(R.string.coktails, R.string.seasonal_margarita_watermelon, R.drawable.watermelon_margarita, R.string.seasonal_margarita_watermelon_desc, R.string.six_fifty_dollar, new int[] {R.drawable.dairy_free, R.drawable.vegan}),
